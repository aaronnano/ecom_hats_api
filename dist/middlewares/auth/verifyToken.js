...
var verifyToken = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, id, email, role;
    return __generator(this, function (_a) {
        token = req.headers['authorization'] // or Authorization - x-access-token
        ;
        if (!token)
        ...
        try {
            ...
            id = decoded // Habiamos definido que la session esta compuesta por id, email
            .id, email = decoded // Habiamos definido que la session esta compuesta por id, email
            .email, role = decoded // Habiamos definido que la session esta compuesta por id, email
            .role;
